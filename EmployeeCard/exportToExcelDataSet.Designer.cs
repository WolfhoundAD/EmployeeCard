...
namespace EmployeeCard {
    ...
    public partial class exportToExcelDataSet : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(string Фамилия, string Имя, string Отчество, int Возраст, string Дата_рождения, string Гражданство, string Адрес, string Должность, string Образование, string Стаж) {
            ...
            private void InitClass() {
                ...
                this.columnСтаж.MaxLength = 2147483647;
            }
        ...
        public partial class СотрудникиRow : global::System.Data.DataRow {
            ...
            public string Гражданство {
                get {
                    try {
                        return ((string)(this[this.tableСотрудники.ГражданствоColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT Id, DepartmentId, LastName, FirstName, MidleName FROM Employees WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Employees.LastName AS Фамилия, Employees.FirstName AS Имя, Employees.MidleName AS Отчество, EmployeePersonalData.Age AS Возраст, EmployeePersonalData.BirthDay AS [Дата рождения], 
                         EmployeePersonalData.Citizenship AS Гражданство, EmployeePersonalData.Address AS Адрес, EmplWorkData.Post AS Должность, EmplWorkData.Education AS Образование, EmplWorkData.WorkExperience AS Стаж
FROM            Employees INNER JOIN
                         EmployeePersonalData ON Employees.Id = EmployeePersonalData.EmployeeId INNER JOIN
                         EmplWorkData ON Employees.Id = EmplWorkData.EmployeeId
